...
def process_image(path, p):
    ...
    # 保存文件
    save_dir = r"D:\PYTHON_PROJECT\OpenCV_PROJECT\imgs"
...
class App:
    def __init__(self, root):
        ...
        # 下方
        file_frame = tk.LabelFrame(right, text="结果文件列表")
        ...
        # 删除
        self.menu = tk.Menu(self.file_listbox, tearoff=0)
        self.menu.add_command(label="删除", command=self.delete_file)
        self.file_listbox.bind("<Button-3>", self.show_menu)
